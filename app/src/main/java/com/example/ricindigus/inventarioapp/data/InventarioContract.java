...
public final class InventarioContract{
    ...
    public static final class ProductosEntry{
        ...
        public static final String COLUMN_PRODUCTO_PEDIDO_PENDIENTE = "pedido_pendiente";

        public static final int PEDIDO_PENDIENTE_VERDADERO = 1;
        public static final int PEDIDO_PENDIENTE_FALSO = 0;
        ...
        public static final String SQL_CREATE_PRODUCTOS_TABLE =
                "CREATE TABLE " + ProductosEntry.TABLE_NAME + " (" +
                        ...
                        ProductosEntry.COLUMN_PRODUCTO_PEDIDO_PENDIENTE + " INTEGER NOT NULL DEFAULT 0" +
                        ");";
    }
